...
<form action="req.php" method="post">
  <div class="cont1 row m-1">
    ...
    <div class="form-group d-xl-flex d-sm-flex col-xl-3 col-md-3 col">
      ...
      <input required value="datepicker" name="datepicker" class="col-xl-8 col-md-8 col-sm-8" id="datepicker">
    </div>
    <div class="col-xl-6 d-flex col-md-6 col">
      ...
      <div class=" d-xl-flex d-sm-flex col-xl-7 col-md-6 col-sm-6">
        ...
        <ul class="pagination ">
          ...
          <li name="aaaa" class="page-item"><a class="page-link" href="#">2</a></li>
          <li name="aaaa" class="page-item"><a class="page-link" href="#">3</a></li>
          <li name="aaaa" class="page-item"><a class="page-link" href="#">4</a></li>
          <li name="aaaa" class="page-item "><a id="pi5" class="page-link" href="#">5</a></li>
        </ul>
      </div>
      ...
      <div class="row m-1">
        <div class="col-xl-5 ">
          <div class="row">
            ...
            <input required value="nazvPlat" name="nazvPlat" type="text" class="form-control col  col-xl-4 col-md-4 col-sm-4" id="nazvPlat">
            <div class="col-xl-5 col-md-5 col-sm-5 col">
              <div class="inline col-xl-12 col-md-6  ">Вид платежа</div>
              <div class="inline ">
                <input required value="rad" checked class="rad " id="avansRad" name="avansRad" type="radio">
                <label for="avansRad">аванс</label>
                <input value="rad" class="rad " id="akancRasch" name="akancRasch" type="radio">
                <label for="akancRasch"> расчет</label>
              </div>
              <div class="inline ">
                <input required value="tokos" name="tokos" type="text" class="col-xl-4 col-md-6 col-sm-6 col-8" id="tokos"> <label for="tokos">%</label>
              </div>
        ...
        <div id="myTableDiv" class="col-xl-6 ">
          ...
          <input required value="addRow" id="addRow" type="button" value="0 Добавить" class="btn btn-primary float-right">
        </div>
  ...
  <div class="cont2 inlne m-2">
    ...
    <div class="rekv p-2">
      ...
      <div class="form-group row">
        ...
        <input required value="bic" name="bic" type="text" class="form-control col-5 col-xl-3 col-md-3 col-sm-3" id="bic">
      ...
      <div class="form-group row">
        ...
        <div class="col-5 col-xl-3 col-md-3 col-sm-3">
          <input required checked value="ufc" name="ufc" type="checkbox" class="form-control  col-1 col-xl-1 col-md-1 col-sm-1" id="ufc">
        </div>
    ...
    <div class="osn p-2">
      <div class="form-group row d-flex">
        <div class="form-group row col-sm-8 col-md-8 col-xl-8">
          ...
          <input required value="bic1" name="bic1" type="text" class="form-control col-3 col-xl-3 col-md-3 col-sm-3" id="bic1">
          <span class="col-form-label">От</span>
          <div class=" col-4 col-xl-5 col-md-5 col-sm-4">
            <input required value="datepicker1" name="datepicker1" class="form-control  col-xl-7 col-md-7 col-sm-7" id="datepicker1">
          </div>
        </div>
        <div class="form-group row col-sm-4 col-md-4 col-xl-4">
          ...
          <input required value="etap" name="etap" type="text" class="form-control col-3 col-xl-4 col-md-4 col-sm-4" id="etap">
      ...
      <div class="form-group row">
        <label for="bic" class="col-3 col-xl-2 col-md-2 col-sm-2 col-form-label">Счет</label>
        <span class="col-form-label">N<sup>o </sup></span>
        <input required value="bic" name="bic" type="text" class="form-control col-3 col-xl-2 col-md-2 col-sm-2" id="bic2">
        <span class="col-form-label">От</span>
        <div class=" col-4 col-xl-2 col-md-3 col-sm-4">
          <input required value="datepicker2" name="datepicker2" class="form-control  col-xl-7 col-md-7 col-sm-7" id="datepicker2">
        </div>
  ...
  <input  type="submit" class="btn btn-success float-right" name="dataAdd">
</form>
